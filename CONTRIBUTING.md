Contributing to EmpireCoin Core
============================

The EmpireCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EmpireCoin Core project, and is not to be
confused with overall EmpireCoin Network Protocol consensus changes.

Whether a pull request is merged into EmpireCoin Core rests with the project merge
...
Patches that change EmpireCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the EmpireCoin consensus, it must have been
...
The project leader is the release manager for each EmpireCoin Core release.
