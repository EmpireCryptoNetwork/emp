...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000cc147f9dee042dd0eeba8462d7b5c80e94a0ea5359c5f14a181fd360ac2"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1555474356, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04bf59faf20b8e66a5d45172328f19ebbd1847426d796240174cc623a27c0a8ad677cedb4264714f317b64a496e566541640eb4d42be2dc691eb880ddaa6eac9d2");
        nDefaultPort = 14321;
        ...
        const char* pszTimestamp = "EmpireCoin new blockchain is here";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0472e1f3d9cbc29ce83d1b1d0230f70aaf75506828a609e46783fc4e5b00a915062f3fcc9802255060aa71cddcb0daa44628bca060839d596f31422067d8710986") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1555474356;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1261885;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000cc147f9dee042dd0eeba8462d7b5c80e94a0ea5359c5f14a181fd360ac2"));
        assert(genesis.hashMerkleRoot == uint256("0x06dbd5a0200068c963f030eceadd49a2f5816721adcf2e4f60673a279226832e"));

	vSeeds.push_back(CDNSSeedData("45.76.39.254", "45.76.39.254"));
        vSeeds.push_back(CDNSSeedData("95.179.133.33", "95.179.133.33"));
        vSeeds.push_back(CDNSSeedData("45.76.36.219", "45.76.36.219"));
	...
	strSporkKey = "042D4D560CBDA9960F99DB0436F56133CCF257C424FB0C9A7662D9829FB75B75DFC8EE2845B2DE8FA4D197052F47C4F7A88001911D56EFCA9E54205614D8585A0F";
        strObfuscationPoolDummyAddress = "EQp8Xc7JD5fii1CG5fJ2KZuxpm9RiSgjC9";
        nStartMasternodePayments = 1555474356;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EmpireCoin: 1 day
        nTargetSpacing = 1 * 60;  // EmpireCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet empirecoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet empirecoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet empirecoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet empirecoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet empirecoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EmpireCoin: 1 day
        nTargetSpacing = 1 * 60;        // EmpireCoin: 1 minutes
