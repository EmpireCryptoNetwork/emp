...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EmpireCoin Core empirecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  empirecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded empirecoin transaction") + "\n" +
                               "  empirecoin-tx [options] -create [commands]   " + _("Create hex-encoded empirecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded empirecoin transaction
