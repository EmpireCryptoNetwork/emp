                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EmpireCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and empirecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EmpireCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about EmpireCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a EmpireCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EmpireCoin Core help message to get a list with possible EmpireCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EmpireCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("EmpireCoin Core"); // default title
...
/** Creates context menu, its actions, and empirecoins up all the relevant signals for mouse events. */
