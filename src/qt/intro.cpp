...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("EmpireCoin Core"),
     ...
     * override -datadir in the empirecoin.conf file in the default data directory
     * (to be consistent with empirecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
