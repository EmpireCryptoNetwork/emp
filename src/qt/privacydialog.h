...
public:
    ...
    void setZEmpireCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzEMP_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzEMP_clicked();
    void on_pushButtonZEmpireCoinControl_clicked();
