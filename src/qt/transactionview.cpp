                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received EmpireCoin from zEMP"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEMP"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEMP));
