...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EmpireCoin features */
        {"empirecoin", "masternode", &masternode, true, true, false},
        {"empirecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"empirecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"empirecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"empirecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"empirecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"empirecoin", "startmasternode", &startmasternode, true, true, false},
        {"empirecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"empirecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"empirecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"empirecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"empirecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"empirecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"empirecoin", "mnbudget", &mnbudget, true, true, false},
        {"empirecoin", "preparebudget", &preparebudget, true, true, false},
        {"empirecoin", "submitbudget", &submitbudget, true, true, false},
        {"empirecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"empirecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"empirecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"empirecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"empirecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"empirecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"empirecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"empirecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"empirecoin", "mnsync", &mnsync, true, true, false},
        {"empirecoin", "spork", &spork, true, true, false},
        {"empirecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"empirecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use empirecoind, or the -server option to empirecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> empirecoin-cli " + methodname + " " + args + "\n";
}
